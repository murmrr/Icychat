...
export interface ChatHeader { 'id' : bigint, 'otherUsers' : Array<Principal> }
export type CreateChatError = { 'ChatAlreadyExists' : null } |
  { 'UserNotFound' : null };
export type GetAllUsersError = { 'UserNotFound' : null };
...
export type Result_5 = { 'ok' : Array<ChatHeader> } |
  { 'err' : GetMyChatHeadersError };
export type Result_6 = { 'ok' : SharedChat } |
  { 'err' : GetMyChatError };
export type Result_7 = { 'ok' : Array<Principal> } |
  { 'err' : GetAllUsersError };
...
export interface _SERVICE {
  ...
  'getAllUsers' : ActorMethod<[], Result_7>,
