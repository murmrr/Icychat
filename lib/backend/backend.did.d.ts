...
export type Result_4 = { ok: Profile } | { err: GetProfileError };
export type Result_5 = { ok: Profile } | { err: GetMyProfileError };
export type Result_6 =
  | { ok: Array<ChatHeader> }
  | { err: GetMyChatHeadersError };
export type Result_7 = { ok: SharedChat } | { err: GetMyChatError };
export type Result_8 = { ok: null } | { err: CreateChatError };
export type Result_9 = { ok: null } | { err: AddToChatError };
