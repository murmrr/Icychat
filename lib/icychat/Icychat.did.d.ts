...
export type LeaveChatError = { 'IdNotFound' : null } |
  { 'UserNotFound' : null };
...
export type Result = { 'ok' : null } |
  { 'err' : SetMyPushTokenError };
export type Result_1 = { 'ok' : SharedChat } |
  { 'err' : SendMessageError };
export type Result_10 = { 'ok' : SharedChat } |
  { 'err' : GetMyChatError };
